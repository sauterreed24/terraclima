...
export const PLACES_CANADA: Place[] = [
  ...
  // =================== TIER C entries ===================
  {
    ...
    experience: {
      ...
      seasons: {
        winter: "The cold season with afternoons near 7°C and nights near 1.4°C — rain is frequent and can be heavy. Winter rewards remote workers who accept the cold season.",
        spring: "The thaw season with afternoons near 13.6°C and nights near 5.2°C — showers pass through regularly. Spring green-up arrives against a wet 1245 mm annual backdrop.",
        summer: "High season with afternoons near 21.5°C and nights near 11.9°C — cool, changeable marine-influenced weather. Sunshine Coast is at its most kinetic for Pacific shoulder-season.",
        autumn: "Fall shoulder with afternoons near 14.3°C and nights near 6.8°C — rain is frequent and can be heavy. Autumn often brings the clearest light and the most honest tradeoffs for rain-shadow sanctuary.",
      },
      travelerFit: "Visitors come for Pacific shoulder-season — the practical way to experience rain-shadow sanctuary terrain in British Columbia.",
...

  {
    ...
    experience: {
      ...
      seasons: {
        winter: "Deep winter with afternoons near 7.3°C and nights near 1.9°C — rain is frequent and can be heavy. Winter rewards artist-farmers who accept the cold season.",
        spring: "Spring opens with afternoons near 13.9°C and nights near 5.1°C — showers pass through regularly. Spring is when rain shadow and marine layer is easiest to read on the ground.",
        summer: "Summer settles with afternoons near 21.4°C and nights near 11.3°C — cool, changeable marine-influenced weather. Salt Spring Island is at its most kinetic for island farm tour.",
        autumn: "Autumn light with afternoons near 14.3°C and nights near 6.8°C — showers pass through regularly. Autumn often brings the clearest light and the most honest tradeoffs for rain-shadow sanctuary.",
      },
      travelerFit: "Visitors come for island farm tour — the practical way to experience rain-shadow sanctuary terrain in British Columbia.",
...

  {
    ...
    experience: {
      ...
      seasons: {
        winter: "The cold season with afternoons near 0.4°C and nights near -6°C — snow is a regular part of the picture. Winter is when British Columbia's interior douglas-fir / bunchgrass shows its teeth.",
        spring: "The thaw season with afternoons near 15.1°C and nights near 2.9°C — weather stays moderate and changeable. Spring is when rain shadow and lake effect is easiest to read on the ground.",
        summer: "High season with afternoons near 27.2°C and nights near 12.2°C — weather stays moderate and changeable. Summerland is at its most kinetic for wine tours. Wildfire and smoke are summer wildcards.",
        autumn: "Fall shoulder with afternoons near 13.7°C and nights near 3.2°C — weather stays moderate and changeable. Autumn often brings the clearest light and the most honest tradeoffs for orchard valley. Fire season lingers into shoulder months.",
      },
      travelerFit: "Visitors come for wine tours — the practical way to experience orchard valley terrain in British Columbia.",
      residentFit: "It rewards wine-country people — especially viticulturalists — if the local tradeoffs still feel acceptable after a full season in Summerland.",
    ...
    liveSignals: {
      ...
      socialStress: 34,
      accessFriction: 38,
      note: "Summerland screening: housing runs expensive relative to regional medians; service access is workable but not metro-dense — confirm hospital and airport distances. Atlas-grade read — confirm on the ground before committing.",
      sources: [
    ...
    confidenceNotes: "Summerland screening uses published normals and atlas archetypes; wildfire and smoke exposure varies sharply by parcel — treat headline scores as regional context, not parcel-grade measurements.",
...

  {
    ...
    experience: {
      feel: "Grand Manan Island — twelve-meter Fundy tides cycle enormous volumes of cold water past the island, producing a dramatically moderated maritime climate: cool wet summers, mild winters, relentless fog, and a salt-scrubbed plant community.",
      seasons: {
        winter: "Deep winter with afternoons near -0.2°C and nights near -6.7°C — rain is frequent and can be heavy. Winter rewards hardy maritime families who accept the cold season. Storm systems roll through with real force.",
...

  {
    ...
    experience: {
      ...
      seasons: {
        winter: "Deep winter with afternoons near -0.1°C and nights near -6.7°C — weather stays moderate and changeable. Winter rewards small-farm families who accept the cold season.",
        spring: "Spring opens with afternoons near 14.3°C and nights near 2.2°C — weather stays moderate and changeable. Spring is when river-valley moderation and rain shadow is easiest to read on the ground.",
        summer: "Summer settles with afternoons near 25.8°C and nights near 11.5°C — showers pass through regularly. Creston Valley is at its most kinetic for wildlife area. Wildfire and smoke are summer wildcards.",
        autumn: "Autumn light with afternoons near 12.9°C and nights near 2.7°C — weather stays moderate and changeable. Autumn often brings the clearest light and the most honest tradeoffs for orchard valley. Fire season lingers into shoulder months.",
      },
      travelerFit: "Visitors come for wildlife area and orchards — the practical way to experience orchard valley terrain in British Columbia.",
    ...
    liveSignals: {
      ...
      socialStress: 34,
      accessFriction: 38,
      note: "Creston Valley screening: housing runs expensive relative to regional medians; service access is workable but not metro-dense — confirm hospital and airport distances. Atlas-grade read — confirm on the ground before committing.",
      sources: [
    ...
    confidenceNotes: "Creston Valley screening uses published normals and atlas archetypes; wildfire and smoke exposure varies sharply by parcel — treat headline scores as regional context, not parcel-grade measurements.",
...

  {
    ...
    experience: {
      ...
      seasons: {
        winter: "Winter settles in with afternoons near 1.3°C and nights near -4.8°C — snow is a regular part of the picture. Winter is when British Columbia's interior ponderosa-bunchgrass shows its teeth.",
        spring: "Spring arrives with afternoons near 15°C and nights near 2.8°C — weather stays moderate and changeable. Spring is when rain shadow and lake effect is easiest to read on the ground.",
        summer: "Summer peaks with afternoons near 27.1°C and nights near 11.9°C — weather stays moderate and changeable. Penticton is at its most kinetic for wine trail. Wildfire and smoke are summer wildcards.",
        autumn: "Autumn turns with afternoons near 13.9°C and nights near 3.2°C — weather stays moderate and changeable. Autumn often brings the clearest light and the most honest tradeoffs for rain-shadow sanctuary. Fire season lingers into shoulder months.",
      },
      travelerFit: "Visitors come for wine trail and beaches — the practical way to experience rain-shadow sanctuary terrain in British Columbia.",
      residentFit: "It rewards sun-desiring Canadians — especially winemakers — if the local tradeoffs still feel acceptable after a full season in Penticton.",
      texture: "An easier place to settle into — the main things to weigh are wildfire exposure and smoke-season air quality. Housing runs expensive relative to regional medians.",
    },
    ...
    liveSignals: {
      ...
      socialStress: 34,
      accessFriction: 38,
      note: "Penticton screening: housing runs expensive relative to regional medians; service access is workable but not metro-dense — confirm hospital and airport distances. Atlas-grade read — confirm on the ground before committing.",
      sources: [
    ...
    confidenceNotes: "Penticton screening uses published normals and atlas archetypes; wildfire and smoke exposure varies sharply by parcel — treat headline scores as regional context, not parcel-grade measurements.",
...

  {
    ...
    experience: {
      ...
      seasons: {
        winter: "Winter runs with afternoons near 0.6°C and nights near -6.8°C — snow is a regular part of the picture. Winter is when British Columbia's bunchgrass / sage steppe shows its teeth.",
        spring: "As spring builds with afternoons near 15.8°C and nights near 2.5°C — weather stays moderate and changeable. Spring is when rain shadow and river-valley moderation is easiest to read on the ground.",
        summer: "The warm months with afternoons near 28.2°C and nights near 12.2°C — weather stays moderate and changeable. Kamloops is at its most kinetic for desert hiking. Plan around heat that can turn genuinely dangerous.",
        autumn: "The shoulder season with afternoons near 13.8°C and nights near 2.6°C — weather stays moderate and changeable. Autumn often brings the clearest light and the most honest tradeoffs for rain-shadow sanctuary. Fire season lingers into shoulder months.",
      },
      travelerFit: "Visitors come for desert hiking and fly-fishing — the practical way to experience rain-shadow sanctuary terrain in British Columbia.",
      residentFit: "It rewards dry-climate-loving British Columbians — especially sun-seeking Canadians — if the local tradeoffs still feel acceptable after a full season in Kamloops.",
    ...
    liveSignals: {
      ...
      socialStress: 34,
      accessFriction: 38,
      note: "Kamloops screening: housing runs expensive relative to regional medians; service access is workable but not metro-dense — confirm hospital and airport distances. Atlas-grade read — confirm on the ground before committing.",
      sources: [
    ...
    confidenceNotes: "Kamloops screening uses published normals and atlas archetypes; wildfire and smoke exposure varies sharply by parcel — treat headline scores as regional context, not parcel-grade measurements.",
...

  {
    ...
    experience: {
      ...
      seasons: {
        winter: "The cold season with afternoons near -1°C and nights near -7.4°C — heavy snow defines the rhythm. Winter is when British Columbia's interior cedar-hemlock shows its teeth. Storm systems roll through with real force.",
        spring: "The thaw season with afternoons near 12.7°C and nights near 1.5°C — snow is a regular part of the picture. Spring green-up arrives against a wet 972 mm annual backdrop. Storm systems roll through with real force.",
        summer: "High season with afternoons near 24.2°C and nights near 10.8°C — showers pass through regularly. Revelstoke is at its most kinetic for ski. Afternoon convection and storms build often.",
        autumn: "Fall shoulder with afternoons near 11.1°C and nights near 2°C — heavy snow defines the rhythm. Autumn often brings the clearest light and the most honest tradeoffs for lake-effect snowbelt. Storm systems roll through with real force.",
      },
      travelerFit: "Visitors come for ski and powder tourism — the practical way to experience lake-effect snowbelt terrain in British Columbia.",
    ...
    liveSignals: {
      ...
      socialStress: 24,
      accessFriction: 60,
      note: "Revelstoke screening: cost sits in a middle band — verify rents and insurance locally; service access is workable but not metro-dense — confirm hospital and airport distances; community fabric reads quieter than larger regional hubs. Atlas-grade read — confirm on the ground before committing.",
      sources: [
...

  {
    ...
    experience: {
      ...
      seasons: {
        winter: "Winter settles in with afternoons near 7.9°C and nights near 2.9°C — rain is frequent and can be heavy. Winter rewards storm-coast romantics who accept the cold season. Storm systems roll through with real force.",
        spring: "Spring arrives with afternoons near 11.4°C and nights near 5.2°C — rain is frequent and can be heavy. Spring green-up arrives against a wet 3532 mm annual backdrop. Storm systems roll through with real force.",
        summer: "Summer peaks with afternoons near 17.6°C and nights near 10.9°C — showers pass through regularly. Ucluelet is at its most kinetic for surfing. Afternoon convection and storms build often.",
        autumn: "Autumn turns with afternoons near 13.8°C and nights near 7.8°C — rain is frequent and can be heavy. Autumn often brings the clearest light and the most honest tradeoffs for hyper-maritime. Storm systems roll through with real force.",
      },
      travelerFit: "Visitors come for surfing and storm watching — the practical way to experience hyper-maritime terrain in British Columbia.",
...

  {
    ...
    experience: {
      ...
      seasons: {
        winter: "Winter runs with afternoons near 7.6°C and nights near 1.6°C — rain is frequent and can be heavy. Winter rewards retirees who accept the cold season.",
        spring: "As spring builds with afternoons near 14.4°C and nights near 5.2°C — showers pass through regularly. Spring green-up arrives against a wet 970 mm annual backdrop.",
        summer: "The warm months with afternoons near 22°C and nights near 11.3°C — cool, changeable marine-influenced weather. Qualicum Beach is at its most kinetic for beaches.",
        autumn: "The shoulder season with afternoons near 14.8°C and nights near 6.9°C — rain is frequent and can be heavy. Autumn often brings the clearest light and the most honest tradeoffs for rain-shadow sanctuary.",
      },
      travelerFit: "Visitors come for beaches and Pacific Rim gateway — the practical way to experience rain-shadow sanctuary terrain in British Columbia.",
...

  {
    ...
    experience: {
      ...
      seasons: {
        winter: "Winter settles in with afternoons near 5.3°C and nights near 0.2°C — rain is frequent and can be heavy. Winter rewards hyper-maritime devotees who accept the cold season. Storm systems roll through with real force.",
        spring: "Spring arrives with afternoons near 9.7°C and nights near 3.1°C — rain is frequent and can be heavy. Spring green-up arrives against a wet 2618 mm annual backdrop. Storm systems roll through with real force.",
        summer: "Summer peaks with afternoons near 16.2°C and nights near 9.9°C — rain is frequent and can be heavy. Prince Rupert is at its most kinetic for Skeena fishing. Afternoon convection and storms build often.",
        autumn: "Autumn turns with afternoons near 11.2°C and nights near 5.8°C — rain is frequent and can be heavy. Autumn often brings the clearest light and the most honest tradeoffs for hyper-maritime. Storm systems roll through with real force.",
      },
      travelerFit: "Visitors come for Skeena fishing and BC Ferries terminus — the practical way to experience hyper-maritime terrain in British Columbia.",
...

  {
    ...
    experience: {
      ...
      seasons: {
        winter: "Winter settles in with afternoons near -0.3°C and nights near -10.8°C — heavy snow defines the rhythm. Winter is when Alberta's fescue prairie / foothills parkland shows its teeth. Arctic outbreaks can still bite hard.",
        spring: "Spring arrives with afternoons near 11.3°C and nights near -1.9°C — snow is a regular part of the picture. Spring is when chinook / foehn downslope is easiest to read on the ground. Storm systems roll through with real force.",
        summer: "Summer peaks with afternoons near 23.4°C and nights near 8.2°C — showers pass through regularly. Pincher Creek is at its most kinetic for Waterton gateway. Afternoon convection and storms build often.",
        autumn: "Autumn turns with afternoons near 11.8°C and nights near -0.9°C — snow is a regular part of the picture. Autumn often brings the clearest light and the most honest tradeoffs for chinook corridor. Storm systems roll through with real force.",
      },
      travelerFit: "Visitors come for Waterton gateway — the practical way to experience chinook corridor terrain in Alberta.",
    ...
    liveSignals: {
      ...
      socialStress: 34,
      accessFriction: 38,
      note: "Pincher Creek screening: cost sits in a middle band — verify rents and insurance locally; service access is workable but not metro-dense — confirm hospital and airport distances. Atlas-grade read — confirm on the ground before committing.",
      sources: [
    ...
    confidenceNotes: "Pincher Creek screening uses published normals and atlas archetypes; severe-storm exposure varies sharply by parcel — treat headline scores as regional context, not parcel-grade measurements.",
...

  {
    ...
    experience: {
      feel: "Cypress Hills rises abruptly from the Saskatchewan prairie, reaching 1460 m — higher than Banff. The elevation produces a cool island of lodgepole pine and aspen in a sea of short-grass prairie. Summer afternoons top out around 22°C on the plateau while the plain below bakes at 32°C.",
      seasons: {
        winter: "Winter settles in with afternoons near -4.1°C and nights near -13.5°C — snow is a regular part of the picture. Winter is when Saskatchewan's montane forest / fescue grassland shows its teeth. Arctic outbreaks can still bite hard.",
        spring: "Spring arrives with afternoons near 9.2°C and nights near -2.7°C — snow is a regular part of the picture. Spring is when elevation lapse rate and continental extremity is easiest to read on the ground.",
        summer: "Summer peaks with afternoons near 22°C and nights near 8.7°C — showers pass through regularly. Cypress Hills is at its most kinetic for dark-sky preserve.",
        autumn: "Autumn turns with afternoons near 9.7°C and nights near -2°C — weather stays moderate and changeable. Autumn often brings the clearest light and the most honest tradeoffs for sky-island refuge.",
      },
      travelerFit: "Visitors come for dark-sky preserve and boreal surprise — the practical way to experience sky-island refuge terrain in Saskatchewan.",
    ...
    liveSignals: {
      ...
      socialStress: 34,
      accessFriction: 38,
      note: "Cypress Hills screening: cost sits in a middle band — verify rents and insurance locally; service access is workable but not metro-dense — confirm hospital and airport distances. Atlas-grade read — confirm on the ground before committing.",
      sources: [
    ...
    confidenceNotes: "Cypress Hills screening uses published normals and atlas archetypes; winter cold varies sharply by parcel — treat headline scores as regional context, not parcel-grade measurements.",
...

  {
    ...
    experience: {
      ...
      seasons: {
        winter: "The cold season with afternoons near 0.9°C and nights near -6.9°C — heavy snow defines the rhythm. Winter is when Ontario's carolinian forest remnants shows its teeth. Storm systems roll through with real force.",
        spring: "The thaw season with afternoons near 12.8°C and nights near 2.6°C — showers pass through regularly. Spring green-up arrives against a wet 906 mm annual backdrop. Storm systems roll through with real force.",
        summer: "High season with afternoons near 25.8°C and nights near 15.8°C — showers pass through regularly. Leamington / Pelee is at its most kinetic for Point Pelee birding. Afternoon convection and storms build often.",
        autumn: "Fall shoulder with afternoons near 15.5°C and nights near 6.8°C — showers pass through regularly. Autumn often brings the clearest light and the most honest tradeoffs for lake-moderated. Storm systems roll through with real force.",
      },
      travelerFit: "Visitors come for Point Pelee birding — the practical way to experience lake-moderated terrain in Ontario.",
    ...
    liveSignals: {
      ...
      socialStress: 34,
      accessFriction: 38,
      note: "Leamington / Pelee screening: cost sits in a middle band — verify rents and insurance locally; service access is workable but not metro-dense — confirm hospital and airport distances. Atlas-grade read — confirm on the ground before committing.",
      sources: [
    ...
    confidenceNotes: "Leamington / Pelee screening uses published normals and atlas archetypes; severe-storm exposure varies sharply by parcel — treat headline scores as regional context, not parcel-grade measurements.",
...

  {
    ...
    experience: {
      ...
      seasons: {
        winter: "Deep winter with afternoons near -5.9°C and nights near -16.4°C — heavy snow defines the rhythm. Winter is when Ontario's boreal forest shows its teeth. Arctic outbreaks can still bite hard.",
        spring: "Spring opens with afternoons near 8.1°C and nights near -3°C — snow is a regular part of the picture. Spring is when lake effect and continental extremity is easiest to read on the ground.",
        summer: "Summer settles with afternoons near 21.8°C and nights near 10.5°C — showers pass through regularly. Thunder Bay is at its most kinetic for Sleeping Giant Park. Wildfire smoke can settle in for stretches.",
        autumn: "Autumn light with afternoons near 9.3°C and nights near 0.6°C — snow is a regular part of the picture. Autumn often brings the clearest light and the most honest tradeoffs for lake-moderated.",
      },
      travelerFit: "Visitors come for Sleeping Giant Park — the practical way to experience lake-moderated terrain in Ontario.",
    ...
    liveSignals: {
      ...
      socialStress: 34,
      accessFriction: 38,
      note: "Thunder Bay screening: cost sits in a middle band — verify rents and insurance locally; service access is workable but not metro-dense — confirm hospital and airport distances. Atlas-grade read — confirm on the ground before committing.",
      sources: [
    ...
    confidenceNotes: "Thunder Bay screening uses published normals and atlas archetypes; winter cold varies sharply by parcel — treat headline scores as regional context, not parcel-grade measurements.",
...

  {
    ...
    experience: {
      ...
      seasons: {
        winter: "Winter settles in with afternoons near -3.9°C and nights near -13°C — heavy snow defines the rhythm. Winter is when Québec's boreal-acadian transition with salt-spray flora shows its teeth. Storm systems roll through with real force.",
        spring: "Spring arrives with afternoons near 6.4°C and nights near -2.8°C — snow is a regular part of the picture. Spring green-up arrives against a wet 1086 mm annual backdrop. Storm systems roll through with real force.",
        summer: "Summer peaks with afternoons near 20°C and nights near 10.1°C — rain is frequent and can be heavy. Gaspé Peninsula Tip is at its most kinetic for Forillon. Afternoon convection and storms build often.",
        autumn: "Autumn turns with afternoons near 9.4°C and nights near 1.7°C — snow is a regular part of the picture. Autumn often brings the clearest light and the most honest tradeoffs for cool-summer maritime. Storm systems roll through with real force.",
      },
      travelerFit: "Visitors come for Forillon and fishing villages — the practical way to experience cool-summer maritime terrain in Québec.",
    ...
    liveSignals: {
      ...
      socialStress: 24,
      accessFriction: 88,
      note: "Gaspé Peninsula Tip screening: cost sits in a middle band — verify rents and insurance locally; specialty care, major airports, or all-weather road access need real planning; community fabric reads quieter than larger regional hubs. Atlas-grade read — confirm on the ground before committing.",
      sources: [
...

  {
    ...
    experience: {
      ...
      seasons: {
        winter: "Winter runs with afternoons near -0.4°C and nights near -7.3°C — heavy snow defines the rhythm. Winter is when Newfoundland and Labrador's boreal-atlantic coastal heath shows its teeth. Storm systems roll through with real force.",
        spring: "As spring builds with afternoons near 7.1°C and nights near -1.5°C — heavy snow defines the rhythm. Spring green-up arrives against a wet 1314 mm annual backdrop. Storm systems roll through with real force.",
        summer: "The warm months with afternoons near 19.6°C and nights near 9.7°C — showers pass through regularly. St. John's is at its most kinetic for iceberg watching. Afternoon convection and storms build often.",
        autumn: "The shoulder season with afternoons near 11.2°C and nights near 3.9°C — rain is frequent and can be heavy. Autumn often brings the clearest light and the most honest tradeoffs for hyper-maritime. Storm systems roll through with real force.",
      },
      travelerFit: "Visitors come for iceberg watching and Jellybean Row — the practical way to experience hyper-maritime terrain in Newfoundland and Labrador.",
...

  {
    ...
    experience: {
      ...
      seasons: {
        winter: "Deep winter with afternoons near -19.7°C and nights near -28.4°C — snow is a regular part of the picture. Winter is when Northwest Territories's boreal-taiga transition shows its teeth. Arctic outbreaks can still bite hard.",
        spring: "Spring opens with afternoons near -1.3°C and nights near -11.4°C — snow is a regular part of the picture. Spring is when continental extremity and polar jet / arctic front is easiest to read on the ground.",
        summer: "Summer settles with afternoons near 19.2°C and nights near 10.3°C — weather stays moderate and changeable. Yellowknife is at its most kinetic for aurora. Wildfire and smoke are summer wildcards.",
        autumn: "Autumn light with afternoons near 0.6°C and nights near -6.5°C — snow is a regular part of the picture. Autumn often brings the clearest light and the most honest tradeoffs for subarctic continental. Fire season lingers into shoulder months.",
      },
      travelerFit: "Visitors come for aurora and ice road — the practical way to experience subarctic continental terrain in Northwest Territories.",
    ...
    liveSignals: {
      ...
      socialStress: 40,
      accessFriction: 44,
      note: "Yellowknife screening: cost sits in a middle band — verify rents and insurance locally; service access is workable but not metro-dense — confirm hospital and airport distances; Poor fit if: cold-sensitive anyone. Atlas-grade read — confirm on the ground before committing.",
      sources: [
    ...
    confidenceNotes: "Yellowknife screening uses published normals and atlas archetypes; wildfire and smoke exposure varies sharply by parcel — treat headline scores as regional context, not parcel-grade measurements.",
...

  {
    ...
    experience: {
      feel: "Churchill sits on Hudson Bay's west shore at 58.8° latitude. Hudson Bay freezes fully in winter, producing continental-cold conditions with lows below −30°C;.",
      seasons: {
        winter: "Winter settles in with afternoons near -19.1°C and nights near -27.9°C — snow is a regular part of the picture. Winter is when Manitoba's subarctic coastal tundra / boreal edge shows its teeth. Arctic outbreaks can still bite hard.",
    ...
    liveSignals: {
      ...
      socialStress: 30,
      accessFriction: 60,
      note: "Churchill screening: cost pressure is relatively modest for the region; service access is workable but not metro-dense — confirm hospital and airport distances; Poor fit if: virtually everyone else permanently. Atlas-grade read — confirm on the ground before committing.",
      sources: [
...

  {
    ...
    experience: {
      ...
      seasons: {
        winter: "Winter runs with afternoons near -1.2°C and nights near -8.6°C — heavy snow defines the rhythm. Winter is when Ontario's carolinian-boreal transition on limestone shows its teeth.",
        spring: "As spring builds with afternoons near 10.6°C and nights near 0.9°C — showers pass through regularly. Spring is when lake effect and karst infiltration is easiest to read on the ground.",
        summer: "The warm months with afternoons near 24.6°C and nights near 13.7°C — showers pass through regularly. Prince Edward County is at its most kinetic for wine trail.",
        autumn: "The shoulder season with afternoons near 13.5°C and nights near 4.8°C — showers pass through regularly. Autumn often brings the clearest light and the most honest tradeoffs for lake-moderated.",
      },
      travelerFit: "Visitors come for wine trail and beaches — the practical way to experience lake-moderated terrain in Ontario.",
    ...
    liveSignals: {
      ...
      socialStress: 34,
      accessFriction: 38,
      note: "Prince Edward County screening: cost sits in a middle band — verify rents and insurance locally; service access is workable but not metro-dense — confirm hospital and airport distances; Poor fit if: those wanting mild winters. Atlas-grade read — confirm on the ground before committing.",
      sources: [
...

  {
    ...
    experience: {
      ...
      seasons: {
        winter: "Deep winter with afternoons near -20.3°C and nights near -29.3°C — snow is a regular part of the picture. Winter is when Nunavut's low-arctic tundra shows its teeth. Arctic outbreaks can still bite hard.",
        spring: "Spring opens with afternoons near -10°C and nights near -18.3°C — snow is a regular part of the picture. Spring is when continental extremity and polar jet / arctic front is easiest to read on the ground.",
        summer: "Summer settles with afternoons near 10.7°C and nights near 3°C — showers pass through regularly. Iqaluit is at its most kinetic for Inuit cultural tourism.",
        autumn: "Autumn light with afternoons near -1.3°C and nights near -7°C — snow is a regular part of the picture. Autumn often brings the clearest light and the most honest tradeoffs for subarctic continental. Hurricane and coastal surge exposure shapes fall planning.",
      },
      travelerFit: "Visitors come for Inuit cultural tourism, Arctic wildlife, and polar nights / midnight sun — the practical way to experience subarctic continental terrain in Nunavut.",
      residentFit: "It rewards people deeply drawn to the Arctic; Inuit residents with cultural/land ties — especially Nunavut government workers — if the local tradeoffs still feel acceptable after a full season in Iqaluit.",
    ...
    liveSignals: {
      ...
      socialStress: 30,
      accessFriction: 60,
      note: "Iqaluit screening: cost sits in a middle band — verify rents and insurance locally; service access is workable but not metro-dense — confirm hospital and airport distances; Poor fit if: essentially anyone not prepared for extreme remoteness and cost of living. Atlas-grade read — confirm on the ground before committing.",
      sources: [
...

  {
    ...
    experience: {
      ...
      seasons: {
        winter: "The cold season with afternoons near -22.3°C and nights near -31°C — snow is a regular part of the picture. Winter is when Northwest Territories's subarctic taiga-tundra transition shows its teeth. Arctic outbreaks can still bite hard.",
        spring: "The thaw season with afternoons near -4.3°C and nights near -16.3°C — snow is a regular part of the picture. Spring is when continental extremity and polar jet / arctic front is easiest to read on the ground.",
        summer: "High season with afternoons near 21.3°C and nights near 8.7°C — weather stays moderate and changeable. Inuvik is at its most kinetic for midnight-sun photography.",
        autumn: "Fall shoulder with afternoons near -1.3°C and nights near -9.3°C — snow is a regular part of the picture. Autumn often brings the clearest light and the most honest tradeoffs for subarctic continental.",
      },
      travelerFit: "Visitors come for midnight-sun photography, aurora (Aug–Apr), and Dempster Highway journey — the practical way to experience subarctic continental terrain in Northwest Territories.",
      residentFit: "It rewards arctic enthusiasts willing to embrace both extremes — especially Arctic researchers — if the local tradeoffs still feel acceptable after a full season in Inuvik.",
    ...
    liveSignals: {
      ...
      socialStress: 40,
      accessFriction: 72,
      note: "Inuvik screening: cost sits in a middle band — verify rents and insurance locally; specialty care, major airports, or all-weather road access need real planning. Atlas-grade read — confirm on the ground before committing.",
      sources: [
    ...
    confidenceNotes: "Inuvik screening uses published normals and atlas archetypes; winter cold varies sharply by parcel — treat headline scores as regional context, not parcel-grade measurements.",
...

  {
    ...
    experience: {
      ...
      seasons: {
        winter: "Deep winter with afternoons near 5.3°C and nights near 1°C — rain is frequent and can be heavy. Winter rewards rainforest residents who accept the cold season. Storm systems roll through with real force.",
        spring: "Spring opens with afternoons near 10°C and nights near 4°C — rain is frequent and can be heavy. Spring green-up arrives against a wet 2165 mm annual backdrop. Storm systems roll through with real force.",
        summer: "Summer settles with afternoons near 16.3°C and nights near 10.7°C — showers pass through regularly. Haida Gwaii is at its most kinetic for Gwaii Haanas National Park. Afternoon convection and storms build often.",
        autumn: "Autumn light with afternoons near 11°C and nights near 6°C — rain is frequent and can be heavy. Autumn often brings the clearest light and the most honest tradeoffs for hyper-maritime. Storm systems roll through with real force.",
      },
      travelerFit: "Visitors come for Gwaii Haanas National Park, Haida cultural tourism, and ancient cedar forests — the practical way to experience hyper-maritime terrain in British Columbia.",
      residentFit: "It rewards those who love cool, wet, remote rainforest country — especially rainforest residents — if the local tradeoffs still feel acceptable after a full season in Queen Charlotte / Skidegate.",
...

  {
    ...
    experience: {
      ...
      seasons: {
        winter: "Winter runs with afternoons near -2°C and nights near -12°C — snow is a regular part of the picture. Winter rewards sun-seekers in Canada who accept the cold season.",
        spring: "As spring builds with afternoons near 13°C and nights near -0.3°C — weather stays moderate and changeable. Spring is when chinook / foehn downslope and rain shadow is easiest to read on the ground.",
        summer: "The warm months with afternoons near 26.3°C and nights near 11°C — showers pass through regularly. Medicine Hat is at its most kinetic for badlands tours. Water supply and irrigation stress matter.",
        autumn: "The shoulder season with afternoons near 13°C and nights near 0°C — weather stays moderate and changeable. Autumn often brings the clearest light and the most honest tradeoffs for chinook corridor.",
      },
      travelerFit: "Visitors come for badlands tours, South Saskatchewan River, and dark-sky observers — the practical way to experience chinook corridor terrain in Alberta.",
      residentFit: "It rewards anyone who wants a Colorado-style Canadian climate: sunny, dry, and chinook-warmed — especially sun-seekers in Canada — if the local tradeoffs still feel acceptable after a full season in Medicine Hat.",
    ...
    liveSignals: {
      ...
      socialStress: 34,
      accessFriction: 38,
      note: "Medicine Hat screening: cost sits in a middle band — verify rents and insurance locally; service access is workable but not metro-dense — confirm hospital and airport distances; Poor fit if: those who expect reliably cold Canadian winters. Atlas-grade read — confirm on the ground before committing.",
      sources: [
    ...
    confidenceNotes: "Medicine Hat screening uses published normals and atlas archetypes; drought and water supply varies sharply by parcel — treat headline scores as regional context, not parcel-grade measurements.",
...

  {
    ...
    experience: {
      feel: "Twillingate sits on the northeast coast of Newfoundland directly in the path of the Labrador Current, which carries Arctic water — and icebergs calved from Greenland — southward every spring.",
      seasons: {
        winter: "Deep winter with afternoons near -2.7°C and nights near -8.7°C — heavy snow defines the rhythm. Winter is when Newfoundland and Labrador's boreal coastal barrens shows its teeth. Storm systems roll through with real force.",
        spring: "Spring opens with afternoons near 5.3°C and nights near -2°C — heavy snow defines the rhythm. Spring green-up arrives against a wet 1225 mm annual backdrop. Storm systems roll through with real force.",
        summer: "Summer settles with afternoons near 18.3°C and nights near 10°C — showers pass through regularly. Twillingate is at its most kinetic for iceberg viewing (May–Jun). Afternoon convection and storms build often.",
        autumn: "Autumn light with afternoons near 9.3°C and nights near 4.3°C — snow is a regular part of the picture. Autumn often brings the clearest light and the most honest tradeoffs for cool-summer maritime. Storm systems roll through with real force.",
      },
      travelerFit: "Visitors come for iceberg viewing (May–Jun), whale watching (Jun–Aug), and cod jigging — the practical way to experience cool-summer maritime terrain in Newfoundland and Labrador.",
      residentFit: "It rewards anyone who wants to watch icebergs from their porch — especially maritime-climate purists — if the local tradeoffs still feel acceptable after a full season in Twillingate.",
      texture: "A real-tradeoff place at sea level — the main things to weigh are storm exposure and coastal and sea-level pressure. Specialty care and major-airport access require real planning.",
    },
    climate: {
...

  {
    ...
    experience: {
      ...
      seasons: {
        winter: "Deep winter with afternoons near 0.7°C and nights near -6.7°C — humid air keeps everything soft and close. Winter rewards viticulture workers who accept the cold season.",
        spring: "Spring opens with afternoons near 16°C and nights near 3.3°C — weather stays moderate and changeable. Spring is when rain shadow and lake effect is easiest to read on the ground.",
        summer: "Summer settles with afternoons near 28.3°C and nights near 12°C — weather stays moderate and changeable. Kelowna is at its most kinetic for wine routes. Wildfire and smoke are summer wildcards.",
        autumn: "Autumn light with afternoons near 14°C and nights near 2.3°C — weather stays moderate and changeable. Autumn often brings the clearest light and the most honest tradeoffs for rain-shadow sanctuary. Fire season lingers into shoulder months.",
      },
      travelerFit: "Visitors come for wine routes and skiing Big White — the practical way to experience rain-shadow sanctuary terrain in British Columbia.",
      residentFit: "It rewards sun-seekers who want Canadian healthcare and mountain-lake scenery — especially viticulture workers — if the local tradeoffs still feel acceptable after a full season in Kelowna.",
    ...
    liveSignals: {
      ...
      socialStress: 34,
      accessFriction: 38,
      note: "Kelowna screening: housing runs expensive relative to regional medians; service access is workable but not metro-dense — confirm hospital and airport distances; Poor fit if: rainforest lovers; smoke-sensitive lungs. Atlas-grade read — confirm on the ground before committing.",
      sources: [
    ...
    confidenceNotes: "Kelowna screening uses published normals and atlas archetypes; wildfire and smoke exposure varies sharply by parcel — treat headline scores as regional context, not parcel-grade measurements.",
  ...
  },
  {
    ...
    experience: {
      ...
      seasons: {
        winter: "Winter runs with afternoons near 5.7°C and nights near 0.3°C — rain is frequent and can be heavy. Winter rewards climbers who accept the cold season. Storm systems roll through with real force.",
        spring: "As spring builds with afternoons near 13.3°C and nights near 5.3°C — rain is frequent and can be heavy. Spring green-up arrives against a wet 2155 mm annual backdrop. Spring rains can swell rivers and arroyos quickly.",
        summer: "The warm months with afternoons near 22°C and nights near 12.3°C — showers pass through regularly. Squamish is at its most kinetic for Stawamus Chief. Wildfire smoke can settle in for stretches.",
        autumn: "The shoulder season with afternoons near 13.7°C and nights near 6°C — rain is frequent and can be heavy. Autumn often brings the clearest light and the most honest tradeoffs for fjord / inlet coast. Storm systems roll through with real force.",
      },
      travelerFit: "Visitors come for Stawamus Chief and Sea to Sky Gondola — the practical way to experience fjord / inlet coast terrain in British Columbia.",
    ...
    liveSignals: {
      ...
      socialStress: 34,
      accessFriction: 38,
      note: "Squamish screening: housing runs expensive relative to regional medians; service access is workable but not metro-dense — confirm hospital and airport distances; Poor fit if: budget renters; sun-belt seekers. Atlas-grade read — confirm on the ground before committing.",
      sources: [
  ...
  },
  {
    ...
    experience: {
      ...
      seasons: {
        winter: "Winter settles in with afternoons near -3.3°C and nights near -13.7°C — weather stays moderate and changeable. Winter rewards hospitality seasonal workers who accept the cold season. Arctic outbreaks can still bite hard.",
        spring: "Spring arrives with afternoons near 9.3°C and nights near -3°C — weather stays moderate and changeable. Spring is when chinook / foehn downslope and elevation lapse rate is easiest to read on the ground.",
        summer: "Summer peaks with afternoons near 21°C and nights near 7°C — showers pass through regularly. Banff is at its most kinetic for Lake Louise. Wildfire and smoke are summer wildcards.",
        autumn: "Autumn turns with afternoons near 9°C and nights near -3°C — weather stays moderate and changeable. Autumn often brings the clearest light and the most honest tradeoffs for chinook corridor. Fire season lingers into shoulder months.",
      },
      travelerFit: "Visitors come for Lake Louise, skiing, and hiking — the practical way to experience chinook corridor terrain in Alberta.",
    ...
    liveSignals: {
      ...
      socialStress: 30,
      accessFriction: 60,
      note: "Banff screening: cost sits in a middle band — verify rents and insurance locally; service access is workable but not metro-dense — confirm hospital and airport distances; Poor fit if: affordable-housing seekers; warm-winter lovers. Atlas-grade read — confirm on the ground before committing.",
      sources: [
  ...
  },
  {
    ...
    experience: {
      ...
      seasons: {
        winter: "Deep winter with afternoons near 1.3°C and nights near -6°C — rain is frequent and can be heavy. Winter rewards students who accept the cold season. Storm systems roll through with real force.",
        spring: "Spring opens with afternoons near 9°C and nights near 2°C — rain is frequent and can be heavy. Spring green-up arrives against a wet 1520 mm annual backdrop. Storm systems roll through with real force.",
        summer: "Summer settles with afternoons near 21.7°C and nights near 14°C — rain is frequent and can be heavy. Halifax is at its most kinetic for Peggy's Cove. Afternoon convection and storms build often.",
        autumn: "Autumn light with afternoons near 14°C and nights near 6°C — rain is frequent and can be heavy. Autumn often brings the clearest light and the most honest tradeoffs for cool-summer maritime. Storm systems roll through with real force.",
      },
      travelerFit: "Visitors come for Peggy's Cove and tidal bore — the practical way to experience cool-summer maritime terrain in Nova Scotia.",
  ...
  },
  {
    ...
    experience: {
      ...
      seasons: {
        winter: "The cold season with afternoons near -1.7°C and nights near -9.7°C — rain is frequent and can be heavy. Winter rewards small-town families who accept the cold season. Storm systems roll through with real force.",
        spring: "The thaw season with afternoons near 7.3°C and nights near 0°C — rain is frequent and can be heavy. Spring green-up arrives against a wet 1265 mm annual backdrop. Storm systems roll through with real force.",
        summer: "High season with afternoons near 22.3°C and nights near 13.7°C — rain is frequent and can be heavy. Charlottetown is at its most kinetic for Green Gables. Afternoon convection and storms build often.",
        autumn: "Fall shoulder with afternoons near 13°C and nights near 4.7°C — rain is frequent and can be heavy. Autumn often brings the clearest light and the most honest tradeoffs for cool-summer maritime. Storm systems roll through with real force.",
      },
      travelerFit: "Visitors come for Green Gables, beaches, and lobster — the practical way to experience cool-summer maritime terrain in Prince Edward Island.",
    ...
    liveSignals: {
      ...
      socialStress: 34,
      accessFriction: 38,
      note: "Charlottetown screening: cost sits in a middle band — verify rents and insurance locally; service access is workable but not metro-dense — confirm hospital and airport distances; Poor fit if: urban nightlife seekers. Atlas-grade read — confirm on the ground before committing.",
      sources: [
  ...
  },
  {
    ...
    experience: {
      feel: "Dawson City sits far inland near the Arctic Circle, where winter cold pools along the Yukon River and summer daylight runs long enough to push gardens fast.",
      seasons: {
        winter: "Deep winter with afternoons near -19.3°C and nights near -29.3°C — snow is a regular part of the picture. Winter is when Yukon's boreal spruce and river alluvium shows its teeth. Arctic outbreaks can still bite hard.",
        spring: "Spring opens with afternoons near 5.3°C and nights near -8.3°C — skies stay mostly dry. Spring is when continental extremity and river-valley moderation is easiest to read on the ground.",
        summer: "Summer settles with afternoons near 21°C and nights near 8°C — showers pass through regularly. Dawson City is at its most kinetic for Klondike history. Wildfire and smoke are summer wildcards.",
        autumn: "Autumn light with afternoons near -1.3°C and nights near -9.3°C — snow is a regular part of the picture. Autumn often brings the clearest light and the most honest tradeoffs for subarctic continental. Fire season lingers into shoulder months.",
      },
      travelerFit: "Visitors come for Klondike history, midnight sun, and aurora — the practical way to experience subarctic continental terrain in Yukon.",
    ...
    liveSignals: {
      ...
      socialStress: 40,
      accessFriction: 72,
      note: "Dawson City screening: cost sits in a middle band — verify rents and insurance locally; specialty care, major airports, or all-weather road access need real planning; Poor fit if: anyone needing easy logistics or mild dark-season weather. Atlas-grade read — confirm on the ground before committing.",
      sources: [
  ...
  },
  {
    ...
    experience: {
      ...
      seasons: {
        winter: "The cold season with afternoons near -8°C and nights near -17.3°C — snow is a regular part of the picture. Winter is when Manitoba's tallgrass prairie and parkland transition shows its teeth. Arctic outbreaks can still bite hard.",
        spring: "The thaw season with afternoons near 10°C and nights near -1.3°C — showers pass through regularly. Spring is when slope / aspect and continental extremity is easiest to read on the ground. Storm systems roll through with real force.",
        summer: "High season with afternoons near 25.3°C and nights near 13°C — showers pass through regularly. Morden & the Pembina Escarpment is at its most kinetic for Morden research station heritage. Water supply and irrigation stress matter.",
        autumn: "Fall shoulder with afternoons near 10.3°C and nights near -0.3°C — weather stays moderate and changeable. Autumn often brings the clearest light and the most honest tradeoffs for orchard valley. Storm systems roll through with real force.",
      },
      travelerFit: "Visitors come for Morden research station heritage and prairie fall — the practical way to experience orchard valley terrain in Manitoba.",
    ...
    liveSignals: {
      ...
      socialStress: 34,
      accessFriction: 38,
      note: "Morden & the Pembina Escarpment screening: cost sits in a middle band — verify rents and insurance locally; service access is workable but not metro-dense — confirm hospital and airport distances. Atlas-grade read — confirm on the ground before committing.",
      sources: [
  ...
  },
  {
    ...
    experience: {
      ...
      seasons: {
        winter: "The cold season with afternoons near -4°C and nights near -14.3°C — heavy snow defines the rhythm. Winter is when Quebec's northern hardwood and maple-beech forest shows its teeth. Arctic outbreaks can still bite hard.",
        spring: "The thaw season with afternoons near 9.7°C and nights near -2.3°C — snow is a regular part of the picture. Spring green-up arrives against a wet 1090 mm annual backdrop. Storm systems roll through with real force.",
        summer: "High season with afternoons near 23.7°C and nights near 10.7°C — rain is frequent and can be heavy. Sutton & the Eastern Townships is at its most kinetic for fall color. Afternoon convection and storms build often.",
        autumn: "Fall shoulder with afternoons near 12°C and nights near 1.3°C — snow is a regular part of the picture. Autumn often brings the clearest light and the most honest tradeoffs for piedmont transition. Storm systems roll through with real force.",
      },
      travelerFit: "Visitors come for fall color, ski weekends, and wine routes — the practical way to experience piedmont transition terrain in Quebec.",
    ...
    liveSignals: {
      ...
      socialStress: 34,
      accessFriction: 38,
      note: "Sutton & the Eastern Townships screening: cost sits in a middle band — verify rents and insurance locally; service access is workable but not metro-dense — confirm hospital and airport distances; Poor fit if: people seeking low-maintenance winter or hot summers. Atlas-grade read — confirm on the ground before committing.",
      sources: [
