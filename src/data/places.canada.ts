...
export const PLACES_CANADA: Place[] = [
  ...
  // =================== TIER C entries ===================
  {
    ...
    experience: {
      ...
      seasons: {
        ...
        summer: "High season with afternoons near 21.5°C and nights near 11.9°C — weather stays moderate and changeable. Sunshine Coast is at its most kinetic for Pacific shoulder-season.",
...

  {
    ...
    experience: {
      ...
      seasons: {
        ...
        summer: "Summer settles with afternoons near 21.4°C and nights near 11.3°C — weather stays moderate and changeable. Salt Spring Island is at its most kinetic for island farm tour.",
...

  {
    ...
    experience: {
      ...
      texture: "A place that asks for a few compromises — the main things to weigh are wildfire exposure and extreme summer heat.",
    },
...

  {
    ...
    experience: {
      ...
      seasons: {
        ...
        summer: "The warm months with afternoons near 22°C and nights near 11.3°C — weather stays moderate and changeable. Qualicum Beach is at its most kinetic for beaches.",
  ...
  },
  {
    ...
    experience: {
      ...
      seasons: {
        ...
        spring: "As spring builds with afternoons near 13.3°C and nights near 5.3°C — rain is frequent and can be heavy. Spring green-up arrives against a wet 2155 mm annual backdrop. Snowmelt and spring rain can swell rivers fast.",
      ...
      texture: "An easier place to settle into at sea level — the main things to weigh are flood and surge risk and smoke-season air quality.",
    },
