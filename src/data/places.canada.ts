...
export const PLACES_CANADA: Place[] = [
  ...
  // =================== TIER C entries ===================
  {
    ...
    experience: {
      feel: "The Sunshine Coast feels like BC's Mediterranean pocket — a ferry-linked mainland coast in the rain shadow of Vancouver Island where sun hours run ~30% above Vancouver, winters stay mild, summers warm enough for grapes and olives on the margin, and the ferry schedule is as real a constraint as the marine layer.",
      seasons: {
        winter: "Mild and bright for the coast — highs near 7°C, nights near 1°C, less rain than the city, and the occasional clear spell that makes the name ring true.",
        spring: "Green and shoulder-perfect — highs climbing through the low teens, wildflowers on the bluffs, and the first warm afternoons that draw weekenders from the mainland.",
        summer: "Dry-side warm — highs near 22°C, irrigation on farms and vineyards, and the rare BC coast summer where a sweater is optional in the afternoon.",
        autumn: "First rains and color — October storms return moisture, maples turn along the inlets, and the ferry queues lengthen again as the season shifts.",
      },
      travelerFit: "Visitors come for Pacific shoulder-season escapes, farm tours, and the 'almost Mediterranean' BC coast.",
      residentFit: "It rewards remote workers and retirees who accept ferry logistics and Vancouver as the specialty-care anchor.",
      texture: "It asks for a few compromises: ferry access friction and moderate wildfire smoke from the interior are the main filters behind the sunnier baseline.",
    },
    climate: { tempHighC: [6.6, 7.8, 10.3, 13.4, 17.1, 19.5, 22.4, 22.6, 19.6, 14.0, 9.2, 6.6], tempLowC: [1.3, 1.4, 2.8, 4.7, 8.0, 10.9, 12.4, 12.5, 10.1, 6.7, 3.6, 1.6], precipMm: [180, 135, 110, 75, 50, 40, 25, 30, 50, 130, 220, 200], humidity: [78, 72, 66, 58, 56, 56, 54, 56, 62, 72, 78, 80], sunshinePct: [32, 40, 48, 55, 62, 68, 72, 70, 60, 48, 35, 28], annualPrecipMm: 1245, frostFreeDays: 220, hardinessZone: "8a" },
...

  {
    ...
    experience: {
      feel: "Salt Spring feels like Vancouver's Mediterranean cousin — a Gulf Island in the Olympic rain shadow where precipitation runs roughly half of the mainland, Garry oak meadows meet sheltered bays, and ferry schedule shapes daily life as much as the marine layer.",
      seasons: {
        winter: "Mild and wet — highs near 7°C, nights near 2°C, and enough rain to keep the island green without the mainland's winter gloom.",
        spring: "Green explosion — highs climbing through the low teens, wildflowers on south-facing slopes, and the first warm afternoons that feel earned.",
        summer: "Dry-side island — highs near 22°C, irrigation ditches running on farms, and summer afternoons that read Mediterranean rather than Pacific Northwest.",
        autumn: "First rains return — October storms green the pastures again, apple harvest on south slopes, and ferry queues lengthen with weekend visitors.",
      },
      travelerFit: "Visitors come for island farm tours, artist studios, and the Gulf Islands' slow-island culture.",
      residentFit: "It rewards artist-farmers and off-grid seekers who accept ferry friction and Victoria as the specialty-care anchor.",
      texture: "It asks for a few compromises: ferry access and tourism-tightened housing are the main filters behind the rain-shadow comfort.",
    },
    climate: { tempHighC: [6.9, 8.2, 10.8, 13.7, 17.1, 19.5, 22.3, 22.5, 19.6, 13.9, 9.3, 6.8], tempLowC: [1.8, 1.9, 3.1, 4.7, 7.6, 10.2, 11.8, 12.0, 9.9, 6.6, 3.9, 2.1], precipMm: [130, 92, 74, 45, 32, 28, 18, 22, 32, 70, 136, 144], humidity: [78, 72, 66, 58, 56, 56, 54, 56, 62, 72, 78, 80], sunshinePct: [35, 42, 52, 62, 72, 78, 84, 82, 68, 52, 38, 32], annualPrecipMm: 823, frostFreeDays: 230, hardinessZone: "8b" },
...

  {
    ...
    experience: {
      feel: "Grand Manan feels like the Bay of Fundy made island — twelve-metre tides cycling enormous volumes of cold water past the shore, cool wet summers, mild winters, relentless fog, and a salt-scrubbed plant community that reads more maritime than mainland New Brunswick.",
      seasons: {
        winter: "Mild and foggy — highs near −1°C, nights near −8°C, and Fundy storms that can stack snow before the tides moderate the air again.",
        spring: "Slow brightening — puffins returning to the cliffs, afternoons climbing through the single digits, and the first whale-watch boats leaving North Head.",
        summer: "Cool and precious — highs near 22°C on the best days, fog that can sit for days, and whale-watching season at its peak.",
        autumn: "Storm and color — hardwoods flare on the headlands, gales rake the island, and ferry schedules become the daily weather report.",
      },
      travelerFit: "Visitors come for whales, puffins, and the experience of a Fundy island where tides define daily life.",
      residentFit: "It rewards hardy maritime families who accept ferry-linked groceries and Saint John as the specialty-care anchor.",
      texture: "It asks for a few compromises: fog intolerance and island access friction are real filters — sun-seekers need a different pin.",
    },
    climate: { tempHighC: [-1.4, -1.1, 2.1, 7.4, 13.4, 18.1, 21.6, 21.8, 18.4, 12.9, 7.1, 1.9], tempLowC: [-7.6, -7.9, -4.3, 0.3, 5.0, 10.1, 13.6, 13.7, 10.3, 5.6, 1.1, -4.6], precipMm: [110, 92, 100, 92, 94, 82, 78, 78, 98, 112, 122, 126], humidity: [80, 78, 76, 74, 76, 78, 80, 82, 82, 80, 80, 82], sunshinePct: [35, 40, 48, 55, 58, 62, 65, 62, 55, 45, 35, 30], annualPrecipMm: 1184, frostFreeDays: 170, hardinessZone: "6a" },
...

  {
    ...
    experience: {
      feel: "Prince Rupert feels like Canada's rainiest city made habitable — 2600 mm of annual precipitation where Pacific storms slam the Coast Mountains, summer highs rarely exceed 18°C, fog and drizzle define the sensory character, and the Skeena-end harbor keeps temperatures between 2 and 17°C year-round.",
      seasons: {
        winter: "Mild and soaking — highs near 5°C, nights near 0°C, and rain that falls as steady drizzle rather than bursts; snow at sea level is rare.",
        spring: "Still wet, brightening — highs climbing through the single digits, salmon season beginning on the Skeena, and the first clear afternoons that reveal the fjord country.",
        summer: "Cool and overcast — highs near 17°C, the driest months still carry marine layer mornings, and locals treat a sunny August week like a festival.",
        autumn: "The big rains return — October can exceed 380 mm, gales rake Kaien Island, and the historic cannery character reasserts itself.",
      },
      travelerFit: "Visitors come for Skeena fishing, BC Ferries gateway trips, and the experience of hyper-maritime North Coast life.",
      residentFit: "It rewards hyper-maritime devotees who accept ~110 sun-days a year and Terrace or Vancouver for specialty care.",
      texture: "A real-tradeoff place: access friction and limited specialty medical access dominate — sun-needing humans need a different atlas pin.",
    },
    climate: { tempHighC: [4.6, 6.1, 7.4, 9.4, 12.3, 14.8, 16.6, 17.1, 14.9, 11.4, 7.4, 5.2], tempLowC: [-0.4, 0.1, 1.1, 2.9, 5.4, 8.4, 10.4, 11.0, 9.1, 5.8, 2.4, 0.8], precipMm: [254, 192, 204, 186, 148, 120, 116, 138, 240, 380, 294, 286], humidity: [82, 80, 78, 77, 78, 80, 82, 83, 84, 85, 83, 82], sunshinePct: [22, 28, 32, 38, 45, 48, 52, 48, 38, 28, 22, 18], annualPrecipMm: 2618, frostFreeDays: 220, hardinessZone: "7b" },
...

  {
    ...
    experience: {
      feel: "St. John's feels like the Atlantic's first stop — North America's foggiest, windiest, wettest major city where the Labrador Current meets the storm track, summers barely reach 21°C, and every transatlantic weather system arrives here before anywhere else on the continent.",
      seasons: {
        winter: "Stormy and mild for Canada — highs near −1°C, nights near −8°C, snow measured in metres, and gales that can rake the Avalon for days.",
        spring: "Slow thaw — ice retreats from the harbour, highs climb through the single digits, and fog can sit for a week without breaking.",
        summer: "Cool and precious — highs near 21°C, the driest months still carry fog mornings, and locals treat a sunny July week like a festival.",
        autumn: "Hurricane remnants and gales — September storms can exceed 100 mm, colours flare on the barrens, and winter arrives early on a northwest flow.",
      },
      travelerFit: "Visitors come for iceberg alley, Signal Hill drama, and the romance of a storm-lashed Atlantic capital.",
      residentFit: "It rewards maritime-loving residents who accept fog, wind, and slope as daily variables in a full regional capital.",
      texture: "It asks for a few compromises: storm exposure and coastal risk rank high — sun-seekers need a different atlas pin.",
    },
    climate: { tempHighC: [-1.1, -1.4, 1.9, 6.8, 12.6, 17.4, 20.8, 20.6, 16.4, 11.1, 6.1, 1.4], tempLowC: [-8.3, -8.9, -5.6, -1.4, 2.6, 6.9, 10.9, 11.2, 7.6, 3.6, 0.4, -4.8], precipMm: [132, 108, 112, 96, 100, 92, 82, 96, 102, 124, 134, 136], snowCm: [82, 76, 60, 32, 4, 0, 0, 0, 0, 2, 20, 80], humidity: [80, 80, 80, 78, 78, 80, 82, 84, 84, 82, 82, 82], sunshinePct: [32, 35, 42, 48, 52, 55, 58, 55, 48, 38, 32, 28], annualPrecipMm: 1314, frostFreeDays: 150, hardinessZone: "6a" },
...

  {
    ...
    experience: {
      feel: "Haida Gwaii feels like the Pacific made archipelago — 100 km off the BC mainland where July highs rarely exceed 17°C, winter rarely freezes, fog and swell define daily life, and the west coast receives more than 4000 mm while the east coast sits in the islands' own rain shadow.",
      seasons: {
        winter: "Mild and wet — highs near 5°C, nights near 1°C, storms stacking against the Queen Charlotte Mountains, and snow rare at sea level.",
        spring: "Slow brightening — highs climbing through the low teens, salmonberry greening the forest floor, and the first dry windows measured in days not weeks.",
        summer: "Cool and precious — highs near 17°C on the west coast, marine layer most mornings, and locals treat a sunny August week like a gift.",
        autumn: "The big rains return — October and November can each exceed 300 mm on the west coast, rivers swell, and Gwaii Haanas closes for the season.",
      },
      travelerFit: "Visitors come for Gwaii Haanas, Haida cultural tourism, and ancient cedar forests in one of Canada's most remote archipelagos.",
      residentFit: "It rewards rainforest residents and cool-climate purists who accept ferry-or-flight-only access and medical logistics as daily reality.",
      texture: "A real-tradeoff place: access friction ranks among the highest in the atlas — warmth and easy travel seekers need a different pin.",
    },
    climate: {
      tempHighC: [5, 6, 7, 10, 13, 15, 17, 17, 15, 11, 7, 5], tempLowC: [1, 1, 2, 4, 6, 9, 11, 12, 9, 6, 3, 1],
      precipMm: [250, 180, 160, 130, 100, 85, 80, 100, 180, 320, 300, 280], humidity: [82, 80, 78, 77, 78, 80, 82, 83, 84, 85, 83, 82], sunshinePct: [28, 32, 38, 45, 52, 55, 58, 55, 42, 32, 28, 25],
  ...
  },
  {
    ...
    experience: {
      feel: "Banff feels like the Rockies at postcard altitude — a Bow Valley town at 1,383 m where chinooks can swing winter from −30°C to thaw in hours, glacier peaks frame every street, and the short summer window delivers crisp dry afternoons before smoke season tints August skies.",
      seasons: {
        winter: "Long and chinook-punctuated — highs near −5°C, nights near −15°C, reliable valley snow, and foehn events that erase the pack on the town floor overnight.",
        spring: "Runoff and reopening — the Bow swelling with meltwater, ski hills closing, and the first hikers returning to Lake Louise trails.",
        summer: "Brief and spectacular — highs near 22°C under intense alpine UV, afternoon thunderstorms over the Front Range, and the park at peak visitation.",
        autumn: "Larch gold and first snow — highs retreating into single digits, elk rut echoing in the valley, and the tourist economy exhaling before winter.",
      },
      travelerFit: "Visitors come for Lake Louise, skiing, and the classic Canadian Rockies national-park experience.",
      residentFit: "It rewards hospitality workers and park staff who accept housing scarcity, seasonal employment, and Calgary as the specialty-care anchor.",
      texture: "A real-tradeoff place: affordable housing is nearly impossible and wildfire smoke increasingly defines summer quality-of-life in the Bow Valley.",
    },
    climate: { tempHighC: [-5, -1, 4, 9, 15, 19, 22, 22, 16, 10, 1, -4], tempLowC: [-15, -12, -8, -3, 2, 6, 8, 7, 3, -2, -10, -14], precipMm: [20, 18, 25, 38, 55, 70, 65, 60, 45, 35, 28, 22], humidity: [68, 64, 58, 52, 50, 52, 54, 56, 58, 62, 68, 72], sunshinePct: [42, 48, 54, 58, 62, 66, 68, 66, 60, 52, 40, 36], annualPrecipMm: 481, frostFreeDays: 90, hardinessZone: "3a" },
    ...
    liveSignals: {
      ...
      socialStress: 42,
      accessFriction: 34,
      note: "National-park tourism economy with severe worker-housing scarcity; Banff Mineral Springs Hospital covers basics but Calgary handles specialty care. Wildfire smoke and shrinking winter reliability are rising climate concerns.",
      sources: [
        { label: "Banff Mineral Springs Hospital", url: "https://www.albertahealthservices.ca/" },
        { label: "ECCC — Banff climate data", url: "https://climate.weather.gc.ca/" },
      ],
    },
