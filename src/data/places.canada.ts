...
export const PLACES_CANADA: Place[] = [
...

  {
    ...
    climate: { tempHighC: [-7, -5, 1, 8, 16, 21, 24, 23, 18, 10, 3, -4], tempLowC: [-17, -16, -10, -2, 4, 9, 12, 11, 6, 0, -5, -13], precipMm: [75, 60, 70, 75, 90, 95, 105, 95, 95, 100, 90, 85], snowCm: [65, 55, 45, 15, 2, 0, 0, 0, 0, 5, 30, 60], humidity: [76, 74, 74, 72, 74, 78, 80, 80, 78, 76, 76, 76], annualPrecipMm: 1035, frostFreeDays: 135, hardinessZone: "4b", chillHours: 2600 },
