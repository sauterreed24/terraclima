...
export const PLACES_CANADA: Place[] = [
...

  {
    ...
    climate: { tempHighC: [-11.4, -7.1, -1.1, 6.8, 14.2, 19.3, 20.9, 19.1, 12.8, 3.4, -6.1, -10.4], tempLowC: [-24.0, -20.8, -14.6, -5.9, 0.6, 5.8, 8.1, 6.6, 2.1, -4.4, -14.8, -21.6], precipMm: [14, 11, 10, 9, 18, 31, 36, 35, 31, 23, 20, 22], snowCm: [20, 14, 10, 4, 2, 0, 0, 0, 2, 14, 26, 28], sunshinePct: [22, 32, 48, 58, 62, 68, 70, 62, 48, 32, 20, 14], annualPrecipMm: 260, frostFreeDays: 70, hardinessZone: "2b" },
