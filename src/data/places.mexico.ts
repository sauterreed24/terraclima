...
export const PLACES_MEXICO: Place[] = [
...

  {
    ...
    experience: {
      feel: "Monterrey mixes high-insolation semi-arid baseline with summer convection that builds against the eastern sierra. Urban expansion amplifies nocturnal heat; industrial air quality interacts with basin geometry. When Gulf moisture taps in, thunderstorms can drop localized hail.",
      seasons: {
        winter: "Winter settles in with afternoons near 21°C and nights near 9°C — weather stays moderate and changeable. Winter rewards manufacturing who accept the cold season. Storm systems roll through with real force.",
        spring: "Spring arrives with afternoons near 29°C and nights near 16°C — weather stays moderate and changeable. Spring is when monsoon convective lift and continental extremity is easiest to read on the ground. Spring rains can swell rivers and arroyos quickly.",
        summer: "Summer peaks with afternoons near 34.7°C and nights near 21.7°C — showers pass through regularly. Monterrey is at its most kinetic for Chipinque. Plan around heat that can turn genuinely dangerous.",
        autumn: "Autumn turns with afternoons near 27.7°C and nights near 15.3°C — showers pass through regularly. Autumn often brings the clearest light and the most honest tradeoffs for monsoon-edge zone. Storm systems roll through with real force.",
      },
      travelerFit: "Visitors come for Chipinque and Cola de Caballo — the practical way to experience monsoon-edge zone terrain in Nuevo León.",
    ...
    confidenceNotes: "City-scale normals for Monterrey are useful; neighborhood heat island, flood pockets, and elevation within the metro can diverge from airport readings — verify block-level exposure.",
  ...
  },
  {
    ...
    experience: {
      feel: "Puebla blends highland spring climate with serious urban pollution in winter inversions. Rain is concentrated summer–monsoon; dry season skies are cobalt. Volcanic ash soils support floriculture and maize.",
      seasons: {
        winter: "The cold season with afternoons near 22.7°C and nights near 6.3°C — skies stay mostly dry. Winter rewards students who accept the cold season. Storm systems roll through with real force.",
        spring: "The thaw season with afternoons near 26.7°C and nights near 10.7°C — weather stays moderate and changeable. Spring is when elevation lapse rate and temperature inversion is easiest to read on the ground. Spring rains can swell rivers and arroyos quickly.",
        summer: "High season with afternoons near 24°C and nights near 11.3°C — rain is frequent and can be heavy. Puebla is at its most kinetic for Talavera. Wildfire smoke can settle in for stretches.",
        autumn: "Fall shoulder with afternoons near 23°C and nights near 9.3°C — showers pass through regularly. Autumn often brings the clearest light and the most honest tradeoffs for volcanic upland. Storm systems roll through with real force.",
      },
      travelerFit: "Visitors come for Talavera and volcano viewpoints — the practical way to experience volcanic upland terrain in Puebla.",
    ...
    confidenceNotes: "City-scale normals for Puebla are useful; neighborhood heat island, flood pockets, and elevation within the metro can diverge from airport readings — verify block-level exposure.",
  ...
  },
  {
    ...
    experience: {
      feel: "Querétaro is a comfort-climate compromise: warmer and drier than Mexico City, less humid than lowland tropics, and increasingly urban. The dry season brings clear light and large day-night swings;.",
      seasons: {
        winter: "Winter settles in with afternoons near 23°C and nights near 6.3°C — skies stay mostly dry with intense sun. Winter rewards professionals who accept the cold season.",
        spring: "Spring arrives with afternoons near 29.3°C and nights near 11.7°C — weather stays moderate and changeable. Spring is when elevation lapse rate and continental extremity is easiest to read on the ground.",
        summer: "Summer peaks with afternoons near 26.7°C and nights near 14.3°C — rain is frequent and can be heavy. Querétaro is at its most kinetic for historic center. Water supply and irrigation stress matter.",
        autumn: "Autumn turns with afternoons near 24.7°C and nights near 10.7°C — showers pass through regularly. Autumn often brings the clearest light and the most honest tradeoffs for eternal-spring highland.",
      },
      travelerFit: "Visitors come for historic center and wine route — the practical way to experience eternal-spring highland terrain in Querétaro.",
      residentFit: "It rewards people who want a dry highland Mexican city with strong services and broad mobility — especially professionals — if the local tradeoffs still feel acceptable after a full season in Santiago de Querétaro.",
      texture: "An easier place to settle into at 1820 m elevation — the main things to weigh are long-run drought. One of the easiest service bases in the Bajio, with airport and industry; growth pressure, water stress, and fringe heat are the counterweights.",
    },
