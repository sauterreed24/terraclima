...
export const PLACES_MEXICO: Place[] = [
  ...
  // =================== TIER C ===================
  {
    ...
    experience: {
      feel: "Coatepec feels like mist made town — a Gulf-slope cloud belt at 1250 m where Atlantic moisture condenses on every hillside, coffee has grown since the early 1800s, and cool humid days average in the low 20s while Xalapa's literary fog sits one valley over.",
      seasons: {
        winter: "Cool and misty — highs near 20°C, nights near 11°C, drizzle possible any day, and coffee farms green on the slopes above town.",
        spring: "Building warmth — highs climbing through the low 20s, wildflowers in the cloud forest, and the first harvest prep before the summer rains.",
        summer: "Rainy season peak — highs near 25°C, afternoon thunderstorms exceeding 280 mm monthly, and saturated slopes that define landslide risk.",
      ...
      travelerFit: "Visitors come for coffee tourism, cloud-forest hikes, and the misty-mountain romance of Veracruz's highlands.",
      residentFit: "It rewards coffee people and cloud-forest lovers who accept perpetual mist and Xalapa as the nearest full-service anchor.",
      texture: "It asks for a few compromises: landslide risk on saturated slopes is elevated — dry-climate and sun-seeking people need a different pin.",
    },
    climate: { tempHighC: [20.1, 21.6, 23.4, 24.9, 25.4, 24.6, 23.8, 24.1, 23.2, 22.3, 21.1, 20.0], tempLowC: [10.9, 11.6, 13.4, 14.9, 15.8, 15.9, 15.6, 15.7, 15.4, 14.2, 12.4, 10.8], precipMm: [56, 38, 40, 68, 132, 284, 278, 262, 306, 212, 96, 62], humidity: [76, 74, 72, 74, 78, 84, 86, 86, 86, 82, 78, 76], sunshinePct: [48, 52, 55, 52, 45, 32, 30, 32, 28, 38, 45, 48], annualPrecipMm: 1834, frostFreeDays: 365, hardinessZone: "11b equiv." },
...

  {
    ...
    biome: "Tropical deciduous forest", koppen: "BSh",
    ...
    climate: {
      tempHighC: [26.9, 28.7, 32.0, 34.8, 37.4, 38.1, 33.4, 32.1, 32.6, 33.1, 29.9, 26.6],
      tempLowC: [8.4, 9.6, 12.1, 15.3, 19.1, 22.3, 22.8, 22.6, 22.0, 18.1, 12.9, 9.1],
      precipMm: [28, 18, 8, 6, 4, 22, 208, 196, 110, 36, 22, 40],
      humidity: [46, 41, 36, 30, 29, 45, 71, 80, 76, 57, 48, 49],
      sunshinePct: [87, 87, 89, 89, 90, 84, 74, 72, 76, 85, 87, 86],
      annualPrecipMm: 698,
      frostFreeDays: 365,
      hardinessZone: "10b equiv.",
    },
    ...
    liveSignals: {
      ...
      sources: [
        { label: "Data Mexico - Alamos municipal profile", url: "https://www.economia.gob.mx/datamexico/en/profile/geo/alamos" },
        { label: "Visit Mexico - Alamos", url: "https://visitmexico.com/en/destino/2102/alamos-sonora" },
        { label: "Instituto Sonorense de Cultura - Festival Alfonso Ortiz Tirado", url: "https://isc.sonora.gob.mx/eventos/faot" },
        { label: "Municipio de Alamos - Proteccion Civil y Bomberos", url: "https://alamos.transparenciasonora.org/category/proteccion-civil-y-bomberos/" },
        { label: "ThinkHazard - Alamos urban flood screen", url: "https://www.thinkhazard.org/es/report/20898-mexico-sonora-alamos/UF" },
      ],
    },
    ...
    confidence: "moderate",
    confidenceNotes: "This promoted Tier C profile is grounded in SMN/CONAGUA context, Climate-Data and Weather Spark cross-checks, and published municipal/tourism signals; parcel-level drainage and summer heat exposure still need verification.",
    citations: [
      { label: "CLICOM/SMN station climate database", kind: "smn", url: "https://cucapa-clicom.cicese.mx/" },
      { label: "Climate-Data.org - Alamos humidity and sun hours", kind: "other", url: "https://en.climate-data.org/north-america/mexico/sonora/alamos-32531/", note: "Monthly sunshinePct is approximated from reported daily sun hours divided by local mid-month daylight." },
      { label: "Weather Spark - Alamos average weather", kind: "other", url: "https://weatherspark.com/y/3077/Average-Weather-in-Alamos-Mexico-Year-Round" },
      { label: "Visit Mexico - Alamos Pueblo Magico", kind: "other", url: "https://visitmexico.com/en/destino/2102/alamos-sonora" },
      { label: "Data Mexico - Alamos municipal profile", kind: "inegi", url: "https://www.economia.gob.mx/datamexico/en/profile/geo/alamos" },
      { label: "Instituto Sonorense de Cultura - Festival Alfonso Ortiz Tirado", kind: "other", url: "https://isc.sonora.gob.mx/eventos/faot" },
      { label: "Municipio de Alamos - Proteccion Civil y Bomberos", kind: "atlas-riesgos", url: "https://alamos.transparenciasonora.org/category/proteccion-civil-y-bomberos/" },
    ],
    deepSections: [
      {
        id: "alamos-dry-winter-green-monsoon",
        title: "Dry winter, green monsoon",
        paragraphs: [
          "Alamos is not an all-year mild escape. Winter and early spring are the easy read: warm afternoons, low humidity, bright skies, and enough elevation above the coastal plain to make the town feel drier and clearer than the humid tropics farther south.",
          "July through September are the real test. The monsoon turns the foothills green and powers birding, gardens, and the dramatic tropical-deciduous landscape, but it also brings muggy nights, heavier downpours, road/drainage questions, and a very different daily rhythm than the dry-season postcard.",
        ],
      },
      {
        id: "alamos-small-town-service-reality",
        title: "A cultural small town with regional-service homework",
        paragraphs: [
          "The Pueblo Magico identity, colonial architecture, and FAOT cultural calendar give Alamos more visitor infrastructure and civic life than its size implies. For travel, that is part of the draw: a compact historic town that can anchor a Sonora foothills trip.",
          "For relocation, the same small scale is the tradeoff. A scout plan should check airport logistics, specialty-care backup, internet reliability, summer cooling costs, and block-level drainage before treating Alamos as move-ready rather than a winter or shoulder-season base.",
        ],
      },
    ],
  },
