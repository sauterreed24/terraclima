...
export const PLACES_MEXICO: Place[] = [
...

  {
    ...
    experience: {
      feel: "San Miguel feels like Mexico's eternal-spring highland — a 1,910 m colonial city where sun-warmed afternoons sit in the low-to-mid 20s most of the year, evenings cool sharply in the dry air, pre-monsoon May peaks near 30°C before summer rain greens the hills, and winter nights can brush freezing while days stay walkable.",
      seasons: {
        winter: "Dry and mild — highs near 23°C, nights near 6°C, brilliant sun on cobblestone streets, and occasional radiative frosts in the outer barrios.",
        spring: "Pre-monsoon heat — afternoons climbing toward 30°C in May, jacarandas blooming, and the hills browning before the rains arrive.",
        summer: "Monsoon relief — highs near 26°C, afternoon storms cooling the air, green hills returning, and the centro at its most lush and walkable.",
        autumn: "Golden dry-down — rains tapering, afternoons settling back into the mid-20s, and festival season under crisp highland evenings.",
      },
      travelerFit: "Visitors come for colonial architecture, highland festivals, and one of Mexico's most walkable mild-weather city breaks.",
      residentFit: "It rewards remote workers and artists who accept expat housing costs, spring water rationing, and León/Querétaro for specialty care.",
      texture: "A real-tradeoff place: water availability is the long-run constraint as pre-monsoon heat intensifies and the Bajío aquifer faces growing demand.",
    },
    climate: {
      ...
      humidity: [45, 42, 38, 38, 44, 58, 66, 68, 66, 58, 50, 46], sunshinePct: [72, 74, 76, 78, 74, 58, 52, 54, 58, 68, 72, 70],
