...
export const PLACES_USA_ROUND2: Place[] = [
  ...
  },
  {
    ...
    confidenceNotes: "City-scale normals for Wilmington are useful; neighborhood heat island, flood pockets, and elevation within the metro can diverge from airport readings — verify block-level exposure.",
  ...
  },
  {
    ...
    confidenceNotes: "City-scale normals for Columbia are useful; neighborhood heat island, flood pockets, and elevation within the metro can diverge from airport readings — verify block-level exposure.",
  ...
  },
  {
    ...
    confidenceNotes: "City-scale normals for Des Moines are useful; neighborhood heat island, flood pockets, and elevation within the metro can diverge from airport readings — verify block-level exposure.",
