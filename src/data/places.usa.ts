...
export const PLACES_USA: Place[] = [
...

  {
    ...
    experience: {
      feel: "Cody feels like Yellowstone's dry chinook gate — a Bighorn Basin city where winter westerlies descending the Absarokas can lift temperatures 25°C in a day, snow vanishes overnight, and the east edge of the Rockies trades Pacific moisture for 250 mm of annual rain and 30+ warm-spell interruptions each winter.",
      seasons: {
        winter: "Chinook country — highs near 2°C, nights near −10°C, and foehn events that erase snowpack on the basin floor while the Absarokas hold white peaks above town.",
        spring: "Runoff and green-up — afternoons climbing through the teens, cottonwoods leafing along the Shoshone, and the first tourist buses heading west to the park gates.",
        summer: "Warm and dry — highs near 30°C under deep blue skies, afternoon thunderstorms building over the Beartooths, and the Bighorn Basin at its most accessible for fishing and rafting.",
        autumn: "Elk and first snow — cottonwoods gold along the river, highs retreating into the mid-teens, and the community bracing for another chinook-punctuated winter.",
      },
      travelerFit: "Visitors come for Yellowstone access, Buffalo Bill Center history, and the classic northern Rockies dry-winter experience.",
      residentFit: "It rewards dry-sun lovers and outdoor workers who accept wind, limited specialty care in Billings, and smoke from regional fires.",
      texture: "A real-tradeoff place: drought trend and elevated smoke rank alongside the chinook warmth that makes Cody one of the northern Rockies' most livable winter basins.",
    },
    ...
    liveSignals: {
      ...
      socialStress: 28,
      accessFriction: 44,
      note: "West Park Hospital covers acute care but Billings remains the specialty-care anchor; tourism and ranching anchor the economy while drought pressure and regional smoke define the long-run comfort math.",
      sources: [
        { label: "West Park Hospital — Cody", url: "https://www.wphospital.org/" },
        { label: "NOAA — Cody WY climate normals", url: "https://www.ncei.noaa.gov/access/us-climate-normals/" },
      ],
    },
...

  {
    ...
    experience: {
      feel: "Moab feels like a red-rock furnace with a river through it — Colorado Plateau canyon walls radiate heat until summer afternoons top 38°C, yet January still averages near 7°C on the canyon floor, and spring and fall deliver the continent's best rock-climbing and mountain-biking weather.",
      seasons: {
        winter: "Mild for the plateau — highs near 7°C, nights near −7°C, occasional snow on the La Sals, and empty trails when the heat-seekers are gone.",
        spring: "Glory season — highs climbing through the high teens and 20s, cool nights for camping, and desert wildflowers against rust-red fins before the June furnace arrives.",
        summer: "Furnace mode — highs near 38°C, rock walls holding heat into the evening, afternoon thunderstorms over Canyonlands, and the Colorado River the only reliable cool-down.",
        autumn: "Perfect shoulder — highs in the low 20s, crisp nights, golden cottonwoods along the river, and the bike trails at their most rideable before winter.",
      },
      travelerFit: "Visitors come for Arches, Canyonlands, world-class mountain biking, and the spring/fall climbing windows.",
      residentFit: "It rewards adventure-sport workers who accept extreme summer heat, water scarcity, and Grand Junction as the medical anchor.",
      texture: "A real-tradeoff place: high drought and extreme-heat risk are the price of living inside one of America's most dramatic desert-oasis corridors.",
    },
    climate: { tempHighC: [6.9, 11.8, 17.9, 23.6, 29.1, 34.8, 37.9, 36.2, 30.9, 22.8, 13.4, 7.1], tempLowC: [-7.1, -3.2, 1.4, 5.4, 10.4, 15.6, 19.1, 18.2, 13.1, 5.8, -0.8, -6.2], precipMm: [16, 18, 22, 22, 18, 12, 18, 26, 30, 28, 22, 20], humidity: [52, 48, 42, 38, 36, 32, 34, 38, 42, 44, 48, 52], sunshinePct: [68, 72, 76, 78, 80, 84, 82, 80, 78, 74, 68, 64], annualPrecipMm: 252, frostFreeDays: 190, hardinessZone: "7b" },
    ...
    liveSignals: {
      ...
      socialStress: 38,
      accessFriction: 48,
      note: "Tourism and outdoor recreation dominate the economy; Moab Regional Hospital covers basics but Grand Junction handles specialty care. Housing pressure and Colorado River water stress are the lived long-run filters.",
      sources: [
        { label: "Moab Regional Hospital", url: "https://www.moabhospital.org/" },
        { label: "NOAA — Moab climate normals", url: "https://www.ncei.noaa.gov/access/us-climate-normals/" },
      ],
    },
...

  {
    ...
    experience: {
      feel: "Marquette feels like Lake Superior's south-shore capital — a granite peninsula where the lake moderates summer to highs near 24°C, delivers 5 m of lake-effect snow most winters, and wraps the town in a maritime character 1,000 km from any ocean.",
      seasons: {
        winter: "Deep and maritime — highs near −5°C, nights near −14°C, lake-effect snow measured in metres, and Superior's open water the engine behind every storm.",
        spring: "Slow thaw — ice retreats from the harbour, highs climb through single digits, and the first warm day on Presque Isle feels like a festival.",
        summer: "Brief and beautiful — highs near 24°C, long daylight on the lake, and the Upper Peninsula at its most accessible for kayaking and Pictured Rocks trips.",
        autumn: "Gales and color — maples and birches flare, northerlies rake the shore, and the community prepares for another Superior winter.",
      },
      travelerFit: "Visitors come for Pictured Rocks, Lake Superior kayaking, and the authentic Great Lakes maritime winter.",
      residentFit: "It rewards Great Lakes devotees who accept long winters, UP access friction, and Green Bay as the practical specialty-care anchor.",
      texture: "A real-tradeoff place: extreme cold and storm exposure define the comfort score — sun-seekers need a different pin on the atlas.",
    },
    ...
    liveSignals: {
      ...
      socialStress: 30,
      accessFriction: 52,
      note: "UPPER Peninsula hub with Northern Michigan University and UP Health System — Marquette; specialty care often means Green Bay or Minneapolis. Housing is modest by coastal standards but winter isolation is real.",
      sources: [
        { label: "UP Health System — Marquette", url: "https://www.mgh.org/" },
        { label: "NOAA — Marquette climate normals", url: "https://www.ncei.noaa.gov/access/us-climate-normals/" },
      ],
    },
...

  {
    ...
    experience: {
      feel: "Asheville feels like the South's mountain refuge — a French Broad basin at 650 m where July highs stay near 28°C instead of Charlotte's 32°C, cove forests hold humidity after summer storms, and the Blue Ridge wraps the city in one of the East's mildest four-season climates.",
      seasons: {
        winter: "Mild with occasional snow — highs near 8°C, nights near −4°C, light dustings on the ridges while the basin stays walkable most weeks.",
        spring: "Orchard awakening — dogwoods and redbuds along the river, afternoon storms building over the Pisgahs, and highs climbing through the teens.",
        summer: "Relief without dryness — highs near 29°C but rarely oppressive, afternoon thunderstorms, and the surrounding ridges 5°C cooler for escape.",
        autumn: "Color and harvest — maples and sourwoods flare on the slopes, crisp mornings return, and the tourist season peaks before winter settles.",
      },
      travelerFit: "Visitors come for Biltmore, Blue Ridge Parkway drives, and a Southern city with real mountain summer relief.",
      residentFit: "It rewards creative remotes and retirees who accept post-Helene flood risk and rising housing pressure in the basin.",
      texture: "A real-tradeoff place: elevated flood and landslide risk after Hurricane Helene reshaped the relocation calculus for the French Broad corridor.",
    },
    ...
    liveSignals: {
      ...
      socialStress: 36,
      accessFriction: 28,
      note: "Mission Hospital anchors a strong regional service base, but post-Helene flood recovery, housing pressure, and wildfire smoke on the ridges are part of the lived relocation filter.",
      sources: [
        { label: "Mission Health — Asheville", url: "https://www.missionhealth.org/" },
...

  {
    ...
    experience: {
      feel: "Stanley feels like the Lower 48's cold sink — a Sawtooth Valley floor at nearly 2,000 m where clear calm nights drain radiative cold into a textbook basin, summer dawns can hit −4°C after 27°C afternoons, and frost has been recorded in every calendar month.",
      seasons: {
        winter: "National-news cold — highs near −2°C, nights near −17°C, and the valley regularly posting the coldest readings in the contiguous US on Arctic outbreaks.",
        spring: "Slow thaw — snow lingers on the Sawtooths, afternoons climb through single digits, and the Salmon River begins its runoff pulse.",
        summer: "Extreme diurnal — highs near 27°C under intense UV, nights falling to 4°C even in July, and afternoon thunderstorms building over the peaks.",
        autumn: "First freeze and first snow — larch gold on the slopes, nights dropping below zero by October, and the valley reminding everyone why the frost-free season is measured in weeks.",
      },
      travelerFit: "Visitors come for Sawtooth backpacking, Salmon River rafting, and Central Idaho Dark Sky Reserve stargazing.",
      residentFit: "It rewards extreme-cold enthusiasts and river guides who accept a 28-day frost-free season and Boise as the specialty-care anchor.",
      texture: "A real-tradeoff place: 30°C diurnal swings and frost-any-month geometry define daily life — gardeners and warmth-seekers need a different pin.",
    },
    climate: {
      ...
      humidity: [70, 65, 55, 50, 50, 45, 42, 44, 50, 60, 70, 72], sunshinePct: [52, 58, 64, 68, 72, 78, 82, 80, 74, 62, 48, 44],
    ...
    liveSignals: {
      ...
      socialStress: 32,
      accessFriction: 68,
      note: "Tiny Sawtooth Valley service base with seasonal tourism and fishing; St. Luke's McCall is the nearest hospital hub and Boise handles specialty care. Single-highway access and extreme cold define the relocation filter.",
      sources: [
        { label: "St. Luke's — McCall", url: "https://www.stlukesonline.org/" },
        { label: "NOAA — Stanley climate records", url: "https://www.ncei.noaa.gov/access/us-climate-normals/" },
      ],
    },
  ...
  },
  {
    ...
    experience: {
      feel: "Leavenworth feels like Bavaria with a rain-shadow passport — a Wenatchee River valley town where Pacific storms die at the Cascade crest, summer heat breaks 31°C, winter snow is reliable for skiing, and chinooks occasionally erase the pack in midwinter while orchards drink irrigation from the river.",
      seasons: {
        winter: "Snowy and cold — highs near 1°C, nights near −6°C, reliable ski-country snow on the Enchantments approach, and occasional chinook thaws that chew the low-elevation pack.",
        spring: "Orchard bloom — apple and pear blossoms along the valley floor, runoff swelling the Wenatchee, and afternoons climbing through the teens.",
        summer: "Hot and dry — highs near 31°C under deep blue skies, river swimming and hiking to alpine lakes, and smoke season that can tint August copper.",
        autumn: "Harvest and Oktoberfest — orchard pickers in the valley, larch gold on the eastern slopes, and the tourist season peaking before winter returns.",
      },
      travelerFit: "Visitors come for Enchantments hikes, Bavarian-themed festivals, and the classic Cascade east-slope four-season experience.",
      residentFit: "It rewards ski families and orchardists who accept high fire and smoke risk and Wenatchee as the medical anchor.",
      texture: "A real-tradeoff place: wildfire and smoke rank high while the rain-shadow sunshine makes this one of Washington's most growable interior valleys.",
    },
    climate: { tempHighC: [1, 4, 10, 16, 22, 26, 31, 30, 25, 16, 7, 1], tempLowC: [-6, -4, 0, 3, 7, 10, 12, 11, 6, 1, -2, -5], precipMm: [55, 45, 35, 25, 30, 20, 10, 12, 18, 35, 55, 65], humidity: [72, 68, 62, 56, 52, 48, 42, 44, 50, 58, 68, 74], sunshinePct: [38, 48, 58, 66, 72, 78, 84, 82, 74, 58, 42, 34], annualPrecipMm: 406, frostFreeDays: 155, hardinessZone: "6b" },
    ...
    liveSignals: {
      ...
      socialStress: 34,
      accessFriction: 38,
      note: "Tourism and orchard agriculture anchor the economy; Cascade Medical Center in Leavenworth covers basics but Wenatchee handles specialty care. Housing pressure and wildfire smoke are the lived long-run concerns.",
      sources: [
        { label: "Cascade Medical Center", url: "https://www.cascademedical.org/" },
        { label: "NOAA — Leavenworth area climate", url: "https://www.ncei.noaa.gov/access/us-climate-normals/" },
      ],
    },
