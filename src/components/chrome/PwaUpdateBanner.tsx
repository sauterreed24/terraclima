...
export function PwaUpdateBanner({ onRefresh, onDismiss }: Props) {
  return (
    <div
      className="tc-pwa-update-banner panel-thin fixed bottom-4 left-4 right-4 z-[79] mx-auto flex max-w-lg flex-col gap-3 p-4 shadow-2xl sm:left-auto sm:right-6 sm:mx-0"
      role="region"
      aria-label="Atlas update"
    >
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0">
          ...
          <p className="m-0 mt-1 text-sm leading-relaxed text-stone-readable" aria-live="polite">
