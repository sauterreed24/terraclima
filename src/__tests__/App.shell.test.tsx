...
describe("App shell", () => {
  ...
  it("does not soft-lock the app shell for shared compare URLs with only invalid place ids", async () => {
    window.history.replaceState(null, "", "/?cmp=not-a-place,also-invalid");
    const { container } = renderApp();
