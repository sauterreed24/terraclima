...
- **Comparison workflow:** Compare up to four places side by side with a decision highlight strip, live-here / livability / felt-comfort rows, climate ribbons, derived scores, responsive columns, and focus-managed modal behavior.
