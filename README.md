...
1. Start from **Live-here fit**, a hero quick pick, or the filter dock's **Fit Finder** paths for heat escape, winter sun, remote work, retirement, gardenability, dry air, coastal buffering, quiet towns, Mexico / Southwest dry-highland scouting, or low fire/smoke; each path discloses the ranking and constraints it will apply.
2. Hover or tap any pin on the map for a one-line climate snapshot, then open a place card for the field-guide profile. Open the place that feels most like where you live now and tap **Set home** in its header — every card, dossier, and comparison then shows climate deltas against your own baseline ("summers 12°F cooler, winters 9°F milder, half the rain").
